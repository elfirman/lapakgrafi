        ...
        <div class="row justify-content-center">
            ...
            <div class="sign-form">
                ...
                <form class="" action="<?php echo e(route('user.forgot.submit')); ?>" method="POST">
                    ...
                    <p class="reg-text text-center mb-0"> Back to  <a href="<?php echo e(route('user.login')); ?>">Login</a></p>
                </form>
            </div>
            </div>
        </div>
...
<?php echo $__env->make('front.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lapakgra/domains/lapakgrafi.my.id/public_html/core/resources/views/user/forgot.blade.php ENDPATH**/ ?>