            ...
            <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title mt-1"><?php echo e(__('Add Job')); ?></h3>
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form class="form-horizontal" action="<?php echo e(route('admin.job.store')); ?>" method="POST" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="position" placeholder="<?php echo e(__('Job Position')); ?>" value="<?php echo e(old('position')); ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="company_name" placeholder="<?php echo e(__('Company Name')); ?>" value="<?php echo e(old('company_name')); ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" name="vacancy" placeholder="<?php echo e(__('Vacancy')); ?>" value="<?php echo e(old('vacancy')); ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                                <textarea name="job_responsibility" class="form-control summernote" id="ck" placeholder="<?php echo e(__('Job Responsibility')); ?>"><?php echo e(old('job_responsibility')); ?></textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                                <textarea name="job_context" class="form-control summernote" id="ck" placeholder="<?php echo e(__('Job Context')); ?>"><?php echo e(old('job_context')); ?></textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                                <textarea name="education_requirement" class="form-control summernote" id="ck" placeholder="<?php echo e(__('Educational Requirements')); ?>"><?php echo e(old('education_requirement')); ?></textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                                <textarea name="experience_requirement" class="form-control summernote" id="ck" placeholder="<?php echo e(__('Experience Requirements')); ?>"><?php echo e(old('experience_requirement')); ?></textarea>
                                            <?php if($errors->has('content')): ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                                <textarea name="additional_requirement" class="form-control summernote" id="ck" placeholder="<?php echo e(__('Additional Requirements')); ?>"><?php echo e(old('additional_requirement')); ?></textarea>
                                            <?php if($errors->has('content')): ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="employment_status" class="form-control">
                                                <option selected="" value="Full-Time"><?php echo e(__('Full-Time')); ?></option>
                                                <option value="Part-Time"><?php echo e(__('Part-Time')); ?></option>
                                                <option value="Project Based"><?php echo e(__('Project Based')); ?></option>
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="job_location" placeholder="<?php echo e(__('Job Location')); ?>" value="<?php echo e(old('job_location')); ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                                <textarea name="other_benefits" class="form-control summernote" id="ck" placeholder="<?php echo e(__('Compensation & Other Benefits')); ?>"><?php echo e(old('other_benefits')); ?></textarea>
                                            <?php if($errors->has('content')): ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="salary" placeholder="<?php echo e(__('Salary')); ?>" value="<?php echo e(old('salary')); ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="submission_date" name="deadline" placeholder="<?php echo e(__('Deadline')); ?>" value="<?php echo e(old('deadline')); ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" data-role="tagsinput" name="meta_tags" placeholder="<?php echo e(__('Meta Tags')); ?>" value="<?php echo e(old('meta_tags')); ?>">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lapakgra/domains/lapakgrafi.my.id/public_html/core/resources/views/admin/job/add.blade.php ENDPATH**/ ?>