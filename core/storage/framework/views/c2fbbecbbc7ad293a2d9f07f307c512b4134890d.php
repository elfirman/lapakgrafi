            ...
            <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title mt-1"><?php echo e(__('Add Product')); ?></h3>
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="<?php echo e(route('admin.product.store')); ?>" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="language_id" class="form-control" id="select_language" data-href="<?php echo e(route('admin.helper.category') . '?table=product_categories'); ?>">
                                                <option value="" selected disabled><?php echo e(__('Select a language')); ?></option>
                                                <?php $__currentLoopData = $langs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($lang->id); ?>" <?php echo e(old('language_id') == $lang->id ? 'selected' : ''); ?> ><?php echo e($lang->name); ?></option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="current_price" placeholder="<?php echo e(__('Current Price')); ?>" value="<?php echo e(old('current_price')); ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="previous_price" placeholder="<?php echo e(__('Previous Price')); ?>" value="<?php echo e(old('previous_price')); ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="sku" placeholder="<?php echo e(__('Sku')); ?>" value="<?php echo e(old('sku')); ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text"  class="form-control" name="stock" placeholder="<?php echo e(__('Product Stock Quantity')); ?>" value="<?php echo e(old('stock')); ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea class="form-control" name="short_description" placeholder="<?php echo e(__('Short Description')); ?>"  rows="2"><?php echo e(old('short_description')); ?></textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                                <textarea name="description" rows="4" class="form-control summernote" id="ck" placeholder="<?php echo e(__('Description')); ?>"><?php echo e(old('description')); ?></textarea>
                                    ...
                                    <div class="form-group row" id="attribute_view">
                                        <label for="file" class="col-sm-2 control-label"><?php echo e(__('Attribute')); ?></label>
                                        <div class="col-sm-10 ">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" data-role="tagsinput" name="tags" placeholder="<?php echo e(__('Tags')); ?>" value="<?php echo e(old('tags')); ?>">
                                        </div>
                                    </div>
	...
	<div class="modal-dialog modal-dialog-centered  modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalCenterTitle"><?php echo e(__('Upload Gallery Images')); ?></h5>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lapakgra/domains/lapakgrafi.my.id/public_html/core/resources/views/admin/product/add.blade.php ENDPATH**/ ?>