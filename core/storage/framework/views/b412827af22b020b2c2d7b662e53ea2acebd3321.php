	...
	<section class="user-dashboard-area section-gap">
		<div class="container">
		  <div class="row">
			...
			<div class="col-lg-9">
                <div class="card">
                    <h5 class="card-header"><?php echo e(__('All Order')); ?></h5>
                    <div class="card-body">
                        <div class="row">
...
<?php echo $__env->make('front.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lapakgra/domains/lapakgrafi.my.id/public_html/core/resources/views/user/order/index.blade.php ENDPATH**/ ?>