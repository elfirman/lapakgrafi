        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-primary card-outline">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form class="form-horizontal" action="<?php echo e(route('admin.blog_section_update', $static->language_id)); ?>" method="POST" >
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="blog_title" placeholder="<?php echo e(__('Title')); ?>" value="<?php echo e($static->blog_title); ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="blog_sub_title" placeholder="<?php echo e(__('Subtitle')); ?>" value="<?php echo e($static->blog_sub_title); ?>">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lapakgra/domains/lapakgrafi.my.id/public_html/core/resources/views/admin/home/blog/index.blade.php ENDPATH**/ ?>